...
#+begin_src dot :file images/node-pivot-leaf.png  :exports results :cache yes
  ...
  node_11 [label = "fo", style = filled, fillcolor = gray]
  node_12 [label = "fum", style = filled, fillcolor = gray]
  node_13 [label = "fi", style = filled, fillcolor = gray]
  node_14 [label = "fie", style = filled, fillcolor = gray]
  pivot_7 [label = "pivot_8", style = filled, fillcolor = green]
  pivot_8 [label = "pivot_7"style = filled, fillcolor = green]
...
#+RESULTS[c11e089de355c4147a9cf7dd366c10b5fb2bd07a]:
